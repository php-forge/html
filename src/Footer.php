...
/**
 * The `<footer>` `HTML` element represents a footer for its nearest ancestor sectioning content or sectioning root
 * element.
 ...
 */
final class Footer extends Base\AbstractElement
{
