...
final class FlowbiteTest extends TestCase
{
    ...
    public function testDropdown(): void
    {
        Assert::equalsWithoutLE(
            <<<HTML
            <a id="button-toggle-658716145f1d9" type="button" role="role" data-dropdown-toggle="button-toggle-658716145f1d9">
    ...
    public function testSidebar(): void
    {
        Assert::equalsWithoutLE(
            <<<HTML
            <button id="button-toggle-658716145f1d9" type="button" aria-controls="button-toggle-658716145f1d9" data-drawer-target="button-toggle-658716145f1d9" data-toggle="button-toggle-658716145f1d9">
