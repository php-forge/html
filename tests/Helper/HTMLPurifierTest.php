...
final class HTMLPurifierTest extends TestCase
{
    ...
    public function testPath(): void
    {
        ...
        $this->assertStringContainsString('clip-rule=&quot;evenodd&quot;', $path);
        $this->assertStringContainsString('fill-rule=&quot;evenodd&quot;', $path);
    }
    ...
    public function testSvg(): void
    {
        $svg = HTMLPurifier::purifyAndEscapeHTML(
            '<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="w-6 h-6" fill="currentColor" viewbox="0 0 20 20"></svg>'
        );
