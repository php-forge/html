...
```php
// generate field id and name
$number->fieldAttributes('model', 'field');
```
...
Refer to the [Attribute Tests](https://github.com/php-forge/html/blob/main/tests/FormControl/Input/Number/AttributeTest.php)
...
Refer to the [Custom Methods Tests](https://github.com/php-forge/html/blob/main/tests/FormControl/Input/Number/CustomMethodTest.php) 
for comprehensive examples.
...
Refer to the [Validate Tests](https://github.com/php-forge/html/blob/main/tests/FormControl/Input/Number/ValidateTest.php)
for comprehensive examples.
