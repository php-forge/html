...
```php
// generate field id and name
$date->fieldAttributes('formModel', 'field');
```
...
Refer to the [Attribute Tests](https://github.com/php-forge/html/blob/main/tests/FormControl/Input/Date/AttributeTest.php)
...
Refer to the [Custom Methods Tests](https://github.com/php-forge/html/blob/main/tests/FormControl/Input/Date/CustomMethodTest.php) 
for comprehensive examples.
...
Refer to the [Validate Tests](https://github.com/php-forge/html/blob/main/tests/FormControl/Input/Date/ValidateTest.php)
for comprehensive examples.
