...
```php
// generate field id and name
$url->fieldAttributes('model', 'field');
```
...
Refer to the [Attribute Tests](https://github.com/php-forge/html/blob/main/tests/FormControl/Input/Url/AttributeTest.php)
...
Refer to the [Custom Methods Tests](https://github.com/php-forge/html/blob/main/tests/FormControl/Input/Url/CustomMethodTest.php)
for comprehensive examples.
...
Refer to the [Validate Tests](https://github.com/php-forge/html/blob/main/tests/FormControl/Input/Url/ValidateTest.php)
for comprehensive examples.
