...
Refer to the [Attribute Tests](https://github.com/php-forge/html/blob/main/tests/FormControl/Input/Text/AttributeTest.php)
...
Refer to the [Custom Methods Tests](https://github.com/php-forge/html/blob/main/tests/FormControl/Input/Text/CustomMethodTest.php)
for comprehensive examples.
...
Refer to the [Validate Tests](https://github.com/php-forge/html/blob/main/tests/FormControl/Input/Text/ValidateTest.php)
for comprehensive examples.
