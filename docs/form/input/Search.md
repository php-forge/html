...
Refer to the [Attribute Tests](https://github.com/php-forge/html/blob/main/tests/Input/Search/AttributeTest.php) for 
...
Refer to the [Custom Methods Tests](https://github.com/php-forge/html/blob/main/tests/Input/Search/CustomMethodTest.php)
...
Refer to the [Validate Tests](https://github.com/php-forge/html/blob/main/tests/Input/Search/ValidateTest.php) for
comprehensive examples.
